 ...
 * @return {Promise}
 */
Environments.prototype.get = function get(id, next) {
  debug('get %s', id);
 ...
 * @return {Promise} 
 */
Environments.prototyp.create = function create(params, next) {
 ...
 * @return {Promise}
 */
Environments.prototype.update = function update(id, params, next) {
  debug('update environment %s: %js', args.id, args.params);

  var args = this.getArgs();
  args.url = 'https://cloud.skytap.com/configurations/:configuration_id';  
  args.params = params;
  args.params.configuration_id = id;
 ...
 * @return {Promise}
 */
Environments.prototype.del = function del(args, next) {
